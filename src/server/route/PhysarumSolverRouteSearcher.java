...
/**
 * 粘菌アルゴリズム（Physarum Solver）による経路探索を行うインターフェース
 */
public interface PhysarumSolverRouteSearcher extends RouteSearchServer {
     ...
     */
    void run_PS(Client client, Queue<Uav> flyingUavQueue, Queue<Uav> uavQueue, ClientController clientController, int numLoop) throws IOException;
     ...
     */
    void updateTubeThickness(int nodeNum, double degeneracyEffect, double deltaTime);
