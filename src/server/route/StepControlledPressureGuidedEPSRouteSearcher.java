        ...
        if (currentPressure < tenPercentReduction) {
            ...
            if (currentFlow < requestedFlow) {
                ...
                if (increaseAmount > 0) {
                    ...
                    LogManager.getInstance().log("StepControlledPGEPS: Source pressure 10% reduction detected " +
                ...
                LogManager.getInstance().log("StepControlledPGEPS: Source pressure 10% reduction detected but flow already at requested level " +
