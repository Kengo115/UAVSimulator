...
/**
 * 拡張粘菌アルゴリズム（Enhanced Physarum Solver）による経路探索を行う実装クラス
 */
public class EnhancedPhysarumSolverRouteSearcherImpl implements EnhancedPhysarumSolverRouteSearcher {
     ...
     */
    public EnhancedPhysarumSolverRouteSearcherImpl(Link[][] linkMatrix, int nodeNum, ResultOutputManager outputManager, 
